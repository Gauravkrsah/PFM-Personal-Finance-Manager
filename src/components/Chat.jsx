...
const getApiBaseUrl = () => {
  ...
  // Use relative path by default to let dev server proxy handle it
  // This works across localhost, IP, and ngrok
  return ''
}
  ...
  return (
    <div className="flex flex-col h-full relative" style={{ display: isVisible ? 'flex' : 'none' }}>
      ...
      {messages.length === 0 ? (
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide px-4 lg:px-8 py-4 pb-48 lg:pb-48">
      ...
      <div className="fixed bottom-14 lg:bottom-0 left-0 right-0 lg:left-56 z-30">
        ...
        <div className="bg-paper-50/95 dark:bg-paper-50/95 backdrop-blur-xl px-4 lg:px-8 py-4 lg:pb-10 lg:pt-6">
          <form onSubmit={handleSubmit} className="relative max-w-7xl mx-auto flex items-center">
            <input
              value={input}
